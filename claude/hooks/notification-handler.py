...
def send_notification(title: str, message: str, sound_name: str = None):
...
def main():
    ...
    with open('/tmp/notification-hook-debug.log', 'a') as f:
        f.write(f"Notification hook called at {os.popen('date').read().strip()}\n")
