...
def rotate_log(log_file: Path, max_size_kb: int = 50, lines_to_keep: int = 100):
    ...
    try:
        ...
        # Silently fail if we can't rotate the log - this is intentional
        # to prevent logging operations from interfering with main functionality
        pass
...
def log_operation(tool_name: str, file_path: str, success: bool):
    ...
    try:
        ...
        # Silently fail if we can't write to log - this is intentional
        # to prevent logging operations from interfering with main functionality
        pass
